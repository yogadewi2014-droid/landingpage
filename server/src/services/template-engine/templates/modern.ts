...
<head>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box;}
    ...
    .hero{position:relative;padding:56px 24px 42px;background:radial-gradient(circle at top left,#8b5cf6 0%,transparent 35%),radial-gradient(circle at top right,#6366f1 0%,transparent 30%),linear-gradient(135deg,#312e81,#4f46e5,#7c3aed);color:white;text-align:center;}
